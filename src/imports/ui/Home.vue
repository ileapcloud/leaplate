<template>
  <div class="home">
    ...
    <p>Work in progress... <a href="https://github.com/leapai/leapai_app_map">Contribute!</a></p>
    ...
    <p><a href="https://github.com/leapai/leapai_app_map" target="_blank">More info</a></p>
